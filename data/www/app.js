...
const FLOW = /^(IF_WIFI|IF_SSID|ELSE_IF|END_IF|IF_OS|ELSE|IF)\b/i;
const CMD = /^(DEFAULT_DELAY|DEFAULTDELAY|RELEASE_KEY|RIGHTARROW|LEFTARROW|BACKSPACE|DOWNARROW|HOLD_KEY|CAPSLOCK|PAGEDOWN|STRINGLN|COMMAND|UPARROW|CONTROL|WINDOWS|ESCAPE|STRING|DELETE|REPEAT|INSERT|PAGEUP|ALTGR|DELAY|SPACE|ENTER|SHIFT|CTRL|HOME|GUI|TAB|ALT|APP|F\d{1,2})\b/i;
const CUSTOM = /^(MOUSE_MOVE_SMOOTH|BRUTEFORCE_LOGIN|BRUTEFORCE_PIN|SELF_DESTRUCT|DISABLE_CAPS|JIGGLE_MOUSE|PCAP_CAPTURE|SCREEN_STATS|MOUSE_CLICK|RANDOM_CHAR|SCREEN_TEXT|TRIGGER_KEY|USB_STORAGE|WAIT_BUTTON|CONNECT_AP|HUMAN_TYPE|RANDOM_NUM|RESET_FIRM|SCREEN_CLR|SCREEN_OFF|DETECT_OS|DISCON_AP|LED_BLINK|SCREEN_ON|ON_ERROR|LED_OFF|DEAUTH|GET_IP|LED_ON|TUNNEL|LABEL|STOP|LOG|VAR)\b/i;
const FLOW_W = /\b(IF_WIFI|IF_SSID|ELSE_IF|END_IF|IF_OS|ELSE|IF)\b/gi;
...
const CMD_W = /\b(DEFAULT_DELAY|DEFAULTDELAY|RELEASE_KEY|RIGHTARROW|LEFTARROW|BACKSPACE|DOWNARROW|HOLD_KEY|CAPSLOCK|PAGEDOWN|STRINGLN|COMMAND|UPARROW|CONTROL|WINDOWS|ESCAPE|DELETE|REPEAT|INSERT|PAGEUP|ALTGR|DELAY|SPACE|ENTER|SHIFT|CTRL|HOME|GUI|TAB|ALT|APP|F\d{1,2})\b/gi;
