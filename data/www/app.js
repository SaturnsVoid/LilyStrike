...
// Auto-derived from ducky.cpp command set (longest-first alternation).
// Regenerate when adding commands to ducky.cpp.
const FLOW = /^(ELSE_IF|IF_SSID|IF_WIFI|END_IF|IF_OS|ELSE|IF)\b/i;
const CMD = /^(DEFAULT_DELAY|DEFAULTDELAY|RELEASE_KEY|RIGHTARROW|LEFTARROW|DOWNARROW|BACKSPACE|PAGEDOWN|CAPSLOCK|STRINGLN|HOLD_KEY|UPARROW|WINDOWS|CONTROL|COMMAND|INSERT|DELETE|PAGEUP|ESCAPE|STRING|REPEAT|SHIFT|SPACE|DELAY|ENTER|ALTGR|CTRL|HOME|APP|GUI|ALT|TAB|F\d{1,2})\b/i;
const CUSTOM = /^(MOUSE_MOVE_SMOOTH|BRUTEFORCE_LOGIN|BRUTEFORCE_PIN|SELF_DESTRUCT|DISABLE_CAPS|JIGGLE_MOUSE|PCAP_CAPTURE|SCREEN_STATS|MOUSE_CLICK|RANDOM_CHAR|SCREEN_TEXT|TRIGGER_KEY|USB_STORAGE|WAIT_BUTTON|CONNECT_AP|HUMAN_TYPE|RANDOM_NUM|RESET_FIRM|RUN_SCRIPT|SCREEN_CLR|SCREEN_OFF|DETECT_OS|DISCON_AP|LED_BLINK|SCREEN_ON|SSID_SPAM|USB_SPOOF|ON_ERROR|LED_OFF|DEAUTH|GET_IP|LED_ON|REBOOT|TUNNEL|LABEL|GOTO|STOP|LOG|VAR)\b/i;
const FLOW_W = /\b(ELSE_IF|IF_SSID|IF_WIFI|END_IF|IF_OS|ELSE|IF)\b/gi;
const CUSTOM_W = /\b(MOUSE_MOVE_SMOOTH|BRUTEFORCE_LOGIN|BRUTEFORCE_PIN|SELF_DESTRUCT|DISABLE_CAPS|JIGGLE_MOUSE|PCAP_CAPTURE|SCREEN_STATS|MOUSE_CLICK|RANDOM_CHAR|SCREEN_TEXT|TRIGGER_KEY|USB_STORAGE|WAIT_BUTTON|CONNECT_AP|HUMAN_TYPE|RANDOM_NUM|RESET_FIRM|RUN_SCRIPT|SCREEN_CLR|SCREEN_OFF|DETECT_OS|DISCON_AP|LED_BLINK|SCREEN_ON|SSID_SPAM|USB_SPOOF|ON_ERROR|LED_OFF|DEAUTH|GET_IP|LED_ON|REBOOT|TUNNEL|LABEL|GOTO|STOP|LOG|VAR)\b/gi;
const CMD_W = /\b(DEFAULT_DELAY|DEFAULTDELAY|RELEASE_KEY|RIGHTARROW|LEFTARROW|DOWNARROW|BACKSPACE|PAGEDOWN|CAPSLOCK|STRINGLN|HOLD_KEY|UPARROW|WINDOWS|CONTROL|COMMAND|INSERT|DELETE|PAGEUP|ESCAPE|REPEAT|SHIFT|SPACE|DELAY|ENTER|ALTGR|CTRL|HOME|APP|GUI|ALT|TAB|F\d{1,2})\b/gi;
